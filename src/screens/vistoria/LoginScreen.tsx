...
export const VistoriaLoginScreen: React.FC = () => {
        ...
        <div>
          ...
          <div className="flex items-center space-x-2 mb-6">
            ...
            <div>
              ...
              <div className="text-[10px] text-gray-500">Lote 15 • PWA Seguro</div>
            </div>
          </div>
          ...
          <p className="text-[11px] text-gray-500 mb-5">
            Insira sua chave de acesso enviada pelo WhatsApp.
          </p>
          ...
          <div className="space-y-3.5">
            <div>
              ...
              <div className="mt-1 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-[12px] font-medium text-gray-700">
                +55 (11) 98765-4321
              </div>
            </div>
            ...
            <div>
              ...
              <span className="text-[9.5px] text-emerald-600 font-medium mt-1 inline-block">
                ✓ Chave validada pelo WhatsApp
              </span>
            </div>
          </div>
        </div>
